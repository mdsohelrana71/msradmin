                      ...
                      <div class="row align-items-center">
                          ...
                          <div class="col col-stats ms-3 ms-sm-0">
                              <div class="numbers">
                                  ...
                                  <h4 class="card-title">{{ number_format($stats['products']) }}</h4>
                              </div>
                          </div>
                      </div>
                  </div>
                      ...
                      <div class="row align-items-center">
                          ...
                          <div class="col col-stats ms-3 ms-sm-0">
                              <div class="numbers">
                                  ...
                                  <h4 class="card-title">{{ number_format($stats['customers']) }}</h4>
                              </div>
                          </div>
                      </div>
                  </div>
                      ...
                      <div class="row align-items-center">
                          ...
                          <div class="col col-stats ms-3 ms-sm-0">
                              <div class="numbers">
                                  ...
                                  <h4 class="card-title">{{ number_format($stats['orders']) }}</h4>
                              </div>
                          </div>
                      </div>
                  </div>
                ...
                <table class="table">
                  <tbody>
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{ asset('assets/img/flags/id.png') }}" alt="indonesia" />
                        </div>
                      </td>
                      <td>Indonesia</td>
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{ asset('assets/img/flags/us.png') }}" alt="united states" />
                        </div>
                      </td>
                      <td>USA</td>
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{ asset('assets/img/flags/au.png') }}" alt="australia" />
                        </div>
                      </td>
                      <td>Australia</td>
