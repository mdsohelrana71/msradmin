                                                        ...
                                                        <td>
                                                            @foreach($perms as $permission)
                                                                <div class="form-check form-check-inline me-2">
                                                                    <input class="form-check-input" type="checkbox" name="permission_ids[]" value="{{ $permission->id }}" id="perm_{{ $permission->id }}" {{ in_array($permission->id, old('permission_ids', $role->permissions->pluck('id')->toArray())) ? 'checked' : '' }}>
